...
const makeOccGrouped = (data) => {
  console.log(
    'This is the start of the makeOccGrouped function, currently unfinished',
  );
  /*
    Container Setup:
  */
  ...
  */
  ...
  const professors = uniqueOccupation.filter((d) => d.match(/PROFESSOR/)); // filter() from https://dailynexusdata.github.io/wrangling
  // also add COLLEGE EDUCATOR, COLLEGE TEACHER, FACULTY, ASST. PROF.
