/**
 * plot pol-contr data by percentage to each committee in 2020
 *
 *
 * @author Julia
 *
...
const makeCommNum2020 = (data) => {
  console.log('This is the start of the makeCommNum2020 function');
  /*
      Container Setup:
    */
  ...
  const container = select('#pol-contr-committee-num-2020').attr(
    'class',
    'pol-contr',
  );
  ...
  container
    .append('h1')
    .text('Percentage of Political Contributions by Committee in 2020');
  ...
  /*
    Create Scales:
  */
  const year2020 = data.filter((d) => parseInt(d.report_year) === 2020);
  // console.log('year2020', year2020);

  const totalContribs = year2020.length;
  // console.log('totalContribs', totalContribs); // 12685

  const committees = year2020.map((d) => d.committee_id);
  ...
  // console.log('numContribsByCommittee', numContribsByCommittee); // 101 of them; why less than 184?
...
export default makeCommNum2020;
// conclusions: 0: {key: 'C00401224', numContribs: 10342} is ActBlue with ~80% of contributions; It Starts Today only had 16 contributions
